<button class="group flex items-center py-1.5 px-2.5 leading-none bg-gray-200 dark:bg-gray-700 rounded hover:line-through hover:bg-rose-500 dark:hover:bg-rose-700"
