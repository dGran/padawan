<div class="antialiased font-sans w-full px-4 md:px-8">
    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 pt-4 pb-2">
        ...
        <h3 class="font-bold uppercase text-sm mt-4 pl-2">
            {{ $race->name }} - Nuevo video
        </h3>
        <div class="form">
            <form id="form-add" method="POST" role="form" action="{{ route('admin.racing.schedule.races.videos.save', [$tournament, $season, $competition, $phase, $group, $race->id]) }}" lang="{{ app()->getLocale() }}">
                @csrf
                ...
                <div class="field-group">
                    <div class="element">
                        ...
                        <input type="text" class="placeholder-gray-400" id="video_id" name="video_id" placeholder="Título" value="{{ old('video_id') }}">
                    </div>
                </div>
