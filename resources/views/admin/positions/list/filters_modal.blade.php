    ...
    <div class="relative w-auto my-6 mx-auto max-w-3xl">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div class="relative p-6 flex-auto">
                ...
                <div class="">
                    <input class="
                    appearance-none block w-full border border-gray-400 rounded py-2 px-4 focus:border-gray-500 placeholder-gray-400" placeholder='Categoría' name="filterCategory" id="filterCategory" value="{{ $filterCategory }}"/>
                </div>
                ...
                <div class="relative">
                    <select name="order" id="order" class="appearance-none h-full rounded border block appearance-none w-full bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                        <option {{ $order == 'order' ? 'selected' : '' }} value="order">
                            Orden (0..9)
                        </option>
                        <option {{ $order == 'order_desc' ? 'selected' : '' }} value="order_desc">
                            Orden (9..0)
                        </option>
                        ...
                        <option {{ $order == 'category' ? 'selected' : '' }} value="category">
                            Categoría (A..Z)
                        </option>
                        <option {{ $order == 'category_desc' ? 'selected' : '' }} value="category_desc">
                            Categoría (Z..A)
                        </option>
                    </select>
                    <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
