    ...
    <div class="form">
        <form id="form-edit" method="POST" role="form" action="{{ route('admin.games.update', $game->id) }}" lang="{{ app()->getLocale() }}" enctype="multipart/form-data">
            ...
            <div class="mt-8">
                ...
                <a href="{{ route('admin.games') }}" class="bg-transparent text-red-500 font-bold uppercase text-sm px-4 py-3 rounded outline-none focus:outline-none ml-2" style="transition: all .15s ease">
                    Cancelar
                </a>
            </div>
