<div class="antialiased font-sans flex px-4 md:px-8 pb-2">
    ...
    <div class="form">
        <form id="form-add" method="POST" role="form" action="{{ route('admin.teams.save') }}" lang="{{ app()->getLocale() }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="field-group">
                ...
                <div class="element">
                    ...
                    <input type="text" class="placeholder-gray-400" id="league_name" name="league_name" placeholder="Liga" autofocus value="{{ old('league_name') }}">
                </div>
            </div>
