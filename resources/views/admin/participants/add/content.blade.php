<div class="antialiased font-sans flex px-4 md:px-8 pb-2">
    ...
    <div class="form">
        <form id="form-add" method="POST" role="form" action="{{ route('admin.participants.save', [$tournament, $season->slug]) }}" lang="{{ app()->getLocale() }}">
            @csrf
            ...
            <label class="custom-label flex pb-4">
                  <div class="bg-white border border-gray-400 rounded w-6 h-6 p-1 flex justify-center items-center mr-2">
                    <input type="checkbox" class="hidden" id="reserve" name="reserve" {{ old('reserve') == "on" ? 'checked' : '' }}>
