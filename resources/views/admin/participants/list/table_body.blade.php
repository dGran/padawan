<tr data-id="{{ $participant->id }}" {{-- data-name="{{ $participant->name }}" --}}>
    <td class="select text-center">
        <label class="custom-check">
            <div>
                <input type="checkbox" class="mark" value="{{ $participant->id }}" name="participantId[]" onchange="showHideRowOptions(this)"/>
