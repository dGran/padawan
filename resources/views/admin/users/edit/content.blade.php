<div class="antialiased font-sans flex px-4 md:px-8 pb-2">
    ...
    <div class="form">
        <form method="POST" role="form" action="{{ route('admin.users.update', $user->id) }}" lang="{{ app()->getLocale() }}" enctype="multipart/form-data">
    	    {{ method_field('PUT') }}
            @csrf
			...
			<div class="flex flex-row mb-3 rounded justify-center">
				<div class="relative">
					<img id="thumbnail" src="{{ $user->profile->avatar() }}" alt="avatar" class="object-cover w-20 h-20 rounded-full border border-gray-500 bg-white p-1">
