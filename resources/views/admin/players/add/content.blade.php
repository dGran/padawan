    ...
    <div class="form">
        <form id="form-add" method="POST" role="form" action="{{ route('admin.players.save') }}" lang="{{ app()->getLocale() }}" enctype="multipart/form-data">
            ...
            <div class="flex flex-row mb-3 rounded justify-center">
                <div class="relative">
                    <img id="thumbnail" src="{{ asset('img/players/default.png') }}" alt="img" class="thumbnail circle">
            ...
            <div class="field-group">
                ...
                <div class="element">
                    ...
                    <input type="number" class="placeholder-gray-400" min="0" id="height" name="height" placeholder="Altura en centímetros" value="{{ old('height') }}">
                </div>
                <div class="element">
                    <label for="age">Edad</label>
                    <input type="number" class="placeholder-gray-400" min="0" id="age" name="age" placeholder="Edad" value="{{ old('age') }}">
                </div>
            </div>
            ...
            <div class="field-group">
                ...
                <div class="element">
                    ...
                    <input type="number" class="placeholder-gray-400" id="game_id" name="game_id" placeholder="ID del jugador en el juego" value="{{ old('game_id') }}">
                </div>
            </div>
