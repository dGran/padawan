<tr data-id="{{ $platform->id }}" data-name="{{ $platform->name }}" data-slug="{{ $platform->slug }}">
    <td class="select text-center">
        <label class="custom-check">
            <div>
                <input type="checkbox" class="mark" value="{{ $platform->id }}" name="platformId[]" onchange="showHideRowOptions(this)"/>
        ...
        <div class="flex items-center">
            ...
            <div class="ml-3">
                {{-- <p class="text-gray-900 whitespace-no-wrap"> --}}
                    ...
                    <span class="block text-gray-600" style="font-size: 9px">ID:{{ $platform->id }}</span>
                {{-- </p> --}}
            </div>
        </div>
    </td>
