<div class="menu">
	...
	<ul class="menu md:mb-4">
		...
		<li class="ml-6 {{ stripos(Request::route()->getName(), 'admin.competitions') !== false || stripos(Request::route()->getName(), 'admin.phases') !== false || stripos(Request::route()->getName(), 'admin.groups') !== false ? 'current' : ''  }}">
