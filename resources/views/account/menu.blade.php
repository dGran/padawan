    ...
    <div class="flex flex-col lg:flex-row lg:justify-between">
        ...
        <div class="pt-3 lg:pt-0 flex items-center justify-center">
            <div class="flex-1 mt-4 lg:my-0 | flex justify-center lg:justify-end space-x-4 sm:space-x-16">
                <a href="{{ route('account') }}" class="group | border-r sm:border-r-0 border-border-color dark:border-dt-border-color flex-1 sm:flex-initial flex flex-col sm:flex-row items-center text-center sm:text-left space-y-1.5 sm:space-y-0 sm:space-x-3 | focus:outline-none {{ Route::currentRouteName() !== 'account' ?: 'pointer-events-none' }}">
