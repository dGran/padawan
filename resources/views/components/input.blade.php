...
<input {{ $disabled ? 'disabled' : '' }}
    {!! $attributes->merge(
        [
            "class" => "appearance-none | rounded | px-4 py-2 | bg-white dark:bg-dt-dark | border border-border-color dark:border-gray-700 |
            ...
            autofill:shadow-fill-white dark:autofill:shadow-fill-dt-dark"
        ]
    ) !!}
>
