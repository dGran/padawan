<div>
    @include('tournament.partials.header', ['activeTab' => 'Stats', 'color' => 'edblue'])

    <x-container>

        <h4 class="mt-8 | font-semibold | font-fjalla | uppercase | text-xl md:text-2xl | tracking-wider | text-title-color dark:text-dt-title-color">Estadísticas</h4>
