                        ...
                        <form class="mt-8" method="POST" action="{{ route('password.confirm') }}">
                            ...
                            <div class="mx-auto max-w-lg">
                                <div class="py-2" x-data="{ show: true }">
                                    ...
                                    <div class="relative">
                                        <input placeholder="" :type="show ? 'password' : 'text'" class="text-md block pl-3 pr-12 py-2 rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none" name="password" id="password" autofocus>
