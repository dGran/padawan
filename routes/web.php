...
Route::prefix('/torneos')->group(function () {
	...
	Route::get('/{tournament:slug}/{season:slug}/normativa', 'TournamentController@rules')->name('tournament.rules');
...
Route::prefix('/admin')->middleware(['auth', 'isAdmin', 'password.confirm'])->group(function () {
	...
	Route::get('/torneos/{tournament:slug}/{season:slug}/{competition:slug}/{phase:slug}/{group:slug}/participantes/nuevo-participante-al-azar', 'Admin\GroupParticipantController@addRandom')->name('admin.groups_participants.add_random');
	Route::get('/torneos/{tournament:slug}/{season:slug}/{competition:slug}/{phase:slug}/{group:slug}/participantes/completar-participantes-al-azar', 'Admin\GroupParticipantController@completeRandom')->name('admin.groups_participants.complete_random');
	Route::get('/torneos/{tournament:slug}/{season:slug}/{competition:slug}/{phase:slug}/{group:slug}/participantes/editar/{id}', 'Admin\GroupParticipantController@edit')->name('admin.groups_participants.edit');
	Route::put('/torneos/{tournament:slug}/{season:slug}/{competition:slug}/{phase:slug}/{group:slug}/participantes/editar/{id}', 'Admin\GroupParticipantController@update')->name('admin.groups_participants.update');
	Route::get('/torneos/{tournament:slug}/{season:slug}/{competition:slug}/{phase:slug}/{group:slug}/participantes/ver/{id}', 'Admin\GroupParticipantController@view')->name('admin.groups_participants.view');
	Route::get('/torneos/{tournament:slug}/{season:slug}/{competition:slug}/{phase:slug}/{group:slug}/participantes/eliminar/{ids}', 'Admin\GroupParticipantController@destroy')->name('admin.groups_participants.destroy');
	...
	Route::get('/torneos/{tournament:slug}/{season:slug}/{competition:slug}/{phase:slug}/{group:slug}/gestion-de-liga/clasificacion', 'Admin\LeagueController@standings')->name('admin.league.standings');
